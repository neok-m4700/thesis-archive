...
def	Start(*args):
    try:
        ...
        err_rate = float(e_input.get())
        relax = float(r_input.get())
        ...
        if input_west == 'Conduction':
            ...
            messagebox.showinfo(message='Select Conduction, Temperature, or Insulated for the West Boundary Condition.')
            return
            pass
        ...
        if input_north == 'Conduction':
            ...
            from tkinter import messagebox
            messagebox.showinfo(message='Select Conduction, Temperature, or Insulated for the North Boundary Condition.')
            return
        ...
        if input_east == 'Conduction':
            ...
            from tkinter import messagebox
            messagebox.showinfo(message='Select Conduction, Temperature, or Insulated for the East Boundary Condition.')
            return
        ...
        if input_south == 'Conduction':
            ...
            from tkinter import messagebox
            messagebox.showinfo(message='Select Conduction, Temperature, or Insulated for the South Boundary Condition.')
            return
        ...
        T = np.zeros((n_nodes, m_nodes))

        # Put Fortran Loops Here
        T = tdm.cond_2d(coeff_matrix, T, err_rate, relax, n_nodes, m_nodes)
...
def Reset(*args):
    ...
    bc_entry_west.delete(0, END)
    bc_entry_east.delete(0, END)
    bc_entry_north.delete(0, END)
    bc_entry_south.delete(0, END)
...
ttk.Label(mainframe, text="Error Threshold").grid(column=1, row=18, sticky=W)
ttk.Label(mainframe, text="Relaxation").grid(column=1, row=19, sticky=W)
...
e_entry = ttk.Entry(mainframe, width=4, textvariable=e_input)
e_entry.grid(column=2, row=18, sticky=(W))

r_entry = ttk.Entry(mainframe, width=4, textvariable=r_input)
r_entry.grid(column=2, row=19, sticky=(W))
